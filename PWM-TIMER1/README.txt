system clock =  72Mhz pll + crystal

This program blinks  PC13 LED @ 0.5Hz using the systick interrupt  .
and  Outputs 35156Hz PWM signal at PA8 (Timer1 chanal1 output) 

The processor goes in sleep mode waiting for systick interrupt.

when systick interrupt occurs the processor handels it. inside the handler PC13 is toggled and duty cycle is incremented and the new value is writen in TIMER2 CCR2 register.
