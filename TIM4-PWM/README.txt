...
and  Outputs 50Hz PWM signal at PB7 (Timer4 chanal2 output) 

The processor goes in sleep mode waiting for systick interrupt.

when systick interrupt occurs the processor handels it. inside the handler PC13 is toggled and duty cycle is incremented and the new value is writen in TIMER4 CCR2 register.
