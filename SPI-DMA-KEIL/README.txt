DMA channel3 memory to SPI1 transfer using TX request.

This prgram sends 0xAA on MOSI pin (PA7) in circular mode at SCK = 18MHz.

hex2bin the generated "dma.hex" in "obj" folder
