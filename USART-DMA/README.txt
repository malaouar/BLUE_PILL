DMA memory to memory transfer + USART1 + 72MHz PLL

This prgram prints a bunch of characters (12345678) , then fill a buffer1 with chars and an other one with letter "L" then uses DMA to transfer contents of buffer1 to buffer2.
then display contents of buffer2.

Last it goes in an echo loop, receive a character then transmit it back.  What you type you get back.
