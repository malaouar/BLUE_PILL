...
This program blinks PA1, PA7 and PA8  LEDs @ 0.5Hz by pulling the COUNTFLAG bit in system timer's (systick) control and status register CSR, this bit which is set every time the counter reachs zero and cleared after reloading automaticallly the "reload value" at the next clock tic .
Notes:
