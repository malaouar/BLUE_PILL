...
/*
  tmpreg |= (uint16_t)(Direction_2Lines_FullDuplex | Mode_Slave | DataSize_8b | CPOL_Low | CPHA_1Edge | NSS_Hard | BaudRatePrescaler_2 | FirstBit_MSB);
*/
				  
	//tmpreg |= (uint16_t)(0x0000 | 0x0000 | 0x0000 | 0x0000 |  0x0000 | 0x0200 |  0x0000 | 0x0000);
	//tmpreg |= (uint16_t)(0x0200 ); // bit9 = 1 => Software slave management enabled (default all other options)

	tmpreg |= (uint16_t)(0x0400 ); // bit10 (RXONLY)= 1 => Receive-only mode, bit9 = 0 => Enable Hard NSS
   ...
   //SPIx->CR2 |= (uint16_t)0x0001; // Bit0 = 1 => Rx buffer DMA enabled
